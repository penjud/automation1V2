...
public:
    ...
    bool hasWebDriverValue() { return m_webDriverValue.has_value(); }
    protocol::Runtime::DeepSerializedValue* getWebDriverValue(protocol::Runtime::DeepSerializedValue* defaultValue) {
       return m_webDriverValue.has_value() ? &m_webDriverValue.value() : defaultValue;
    }
