...
V8_EXPORT int v8dbg_FirstJSFunctionType = FIRST_JS_FUNCTION_TYPE;
V8_EXPORT int v8dbg_LastJSFunctionType = LAST_JS_FUNCTION_TYPE;
...
V8_EXPORT int v8dbg_DeoptimizationDataInlinedFunctionCountIndex = DeoptimizationData::kInlinedFunctionCountIndex;
V8_EXPORT int v8dbg_DeoptimizationDataLiteralArrayIndex = DeoptimizationData::kLiteralArrayIndex;
V8_EXPORT int v8dbg_DeoptimizationDataOptimizationIdIndex = DeoptimizationData::kOptimizationIdIndex;
V8_EXPORT int v8dbg_DeoptimizationDataSharedFunctionInfoIndex = DeoptimizationData::kSharedFunctionInfoIndex;
V8_EXPORT int v8dbg_DeoptimizationDataInliningPositionsIndex = DeoptimizationData::kInliningPositionsIndex;
...
V8_EXPORT int v8dbg_type_ConsString__CONS_TWO_BYTE_STRING_TYPE = CONS_TWO_BYTE_STRING_TYPE;
...
V8_EXPORT int v8dbg_type_ExternalPointerArray__EXTERNAL_POINTER_ARRAY_TYPE = EXTERNAL_POINTER_ARRAY_TYPE;
V8_EXPORT int v8dbg_type_ExternalTwoByteString__EXTERNAL_TWO_BYTE_STRING_TYPE = EXTERNAL_TWO_BYTE_STRING_TYPE;
...
V8_EXPORT int v8dbg_type_Foreign__FOREIGN_TYPE = FOREIGN_TYPE;
...
V8_EXPORT int v8dbg_type_Hole__HOLE_TYPE = HOLE_TYPE;
V8_EXPORT int v8dbg_type_InstructionStream__INSTRUCTION_STREAM_TYPE = INSTRUCTION_STREAM_TYPE;
V8_EXPORT int v8dbg_type_InterceptorInfo__INTERCEPTOR_INFO_TYPE = INTERCEPTOR_INFO_TYPE;
V8_EXPORT int v8dbg_type_InternalizedString__INTERNALIZED_ONE_BYTE_STRING_TYPE = INTERNALIZED_ONE_BYTE_STRING_TYPE;
V8_EXPORT int v8dbg_type_InternalizedString__INTERNALIZED_TWO_BYTE_STRING_TYPE = INTERNALIZED_TWO_BYTE_STRING_TYPE;
...
V8_EXPORT int v8dbg_type_JSAtomicsCondition__JS_ATOMICS_CONDITION_TYPE = JS_ATOMICS_CONDITION_TYPE;
V8_EXPORT int v8dbg_type_JSAtomicsMutex__JS_ATOMICS_MUTEX_TYPE = JS_ATOMICS_MUTEX_TYPE;
...
V8_EXPORT int v8dbg_type_JSDurationFormat__JS_DURATION_FORMAT_TYPE = JS_DURATION_FORMAT_TYPE;
...
V8_EXPORT int v8dbg_type_JSIteratorDropHelper__JS_ITERATOR_DROP_HELPER_TYPE = JS_ITERATOR_DROP_HELPER_TYPE;
V8_EXPORT int v8dbg_type_JSIteratorFilterHelper__JS_ITERATOR_FILTER_HELPER_TYPE = JS_ITERATOR_FILTER_HELPER_TYPE;
V8_EXPORT int v8dbg_type_JSIteratorFlatMapHelper__JS_ITERATOR_FLAT_MAP_HELPER_TYPE = JS_ITERATOR_FLAT_MAP_HELPER_TYPE;
V8_EXPORT int v8dbg_type_JSIteratorMapHelper__JS_ITERATOR_MAP_HELPER_TYPE = JS_ITERATOR_MAP_HELPER_TYPE;
V8_EXPORT int v8dbg_type_JSIteratorTakeHelper__JS_ITERATOR_TAKE_HELPER_TYPE = JS_ITERATOR_TAKE_HELPER_TYPE;
...
V8_EXPORT int v8dbg_type_JSRabGsabDataView__JS_RAB_GSAB_DATA_VIEW_TYPE = JS_RAB_GSAB_DATA_VIEW_TYPE;
V8_EXPORT int v8dbg_type_JSRawJson__JS_RAW_JSON_TYPE = JS_RAW_JSON_TYPE;
...
V8_EXPORT int v8dbg_type_JSSharedArray__JS_SHARED_ARRAY_TYPE = JS_SHARED_ARRAY_TYPE;
...
V8_EXPORT int v8dbg_type_JSValidIteratorWrapper__JS_VALID_ITERATOR_WRAPPER_TYPE = JS_VALID_ITERATOR_WRAPPER_TYPE;
...
V8_EXPORT int v8dbg_type_SeqOneByteString__SEQ_ONE_BYTE_STRING_TYPE = SEQ_ONE_BYTE_STRING_TYPE;
V8_EXPORT int v8dbg_type_SeqTwoByteString__SEQ_TWO_BYTE_STRING_TYPE = SEQ_TWO_BYTE_STRING_TYPE;
...
V8_EXPORT int v8dbg_type_SlicedString__SLICED_TWO_BYTE_STRING_TYPE = SLICED_TWO_BYTE_STRING_TYPE;
...
V8_EXPORT int v8dbg_type_ThinString__THIN_ONE_BYTE_STRING_TYPE = THIN_ONE_BYTE_STRING_TYPE;
V8_EXPORT int v8dbg_type_ThinString__THIN_TWO_BYTE_STRING_TYPE = THIN_TWO_BYTE_STRING_TYPE;
...
V8_EXPORT int v8dbg_type_TurboshaftFloat64RangeType__TURBOSHAFT_FLOAT64_RANGE_TYPE_TYPE = TURBOSHAFT_FLOAT64_RANGE_TYPE_TYPE;
V8_EXPORT int v8dbg_type_TurboshaftFloat64SetType__TURBOSHAFT_FLOAT64_SET_TYPE_TYPE = TURBOSHAFT_FLOAT64_SET_TYPE_TYPE;
V8_EXPORT int v8dbg_type_TurboshaftWord32RangeType__TURBOSHAFT_WORD32_RANGE_TYPE_TYPE = TURBOSHAFT_WORD32_RANGE_TYPE_TYPE;
V8_EXPORT int v8dbg_type_TurboshaftWord32SetType__TURBOSHAFT_WORD32_SET_TYPE_TYPE = TURBOSHAFT_WORD32_SET_TYPE_TYPE;
V8_EXPORT int v8dbg_type_TurboshaftWord64RangeType__TURBOSHAFT_WORD64_RANGE_TYPE_TYPE = TURBOSHAFT_WORD64_RANGE_TYPE_TYPE;
V8_EXPORT int v8dbg_type_TurboshaftWord64SetType__TURBOSHAFT_WORD64_SET_TYPE_TYPE = TURBOSHAFT_WORD64_SET_TYPE_TYPE;
...
V8_EXPORT int v8dbg_type_WasmNull__WASM_NULL_TYPE = WASM_NULL_TYPE;
V8_EXPORT int v8dbg_type_WasmResumeData__WASM_RESUME_DATA_TYPE = WASM_RESUME_DATA_TYPE;
V8_EXPORT int v8dbg_type_WasmStringViewIter__WASM_STRING_VIEW_ITER_TYPE = WASM_STRING_VIEW_ITER_TYPE;
...
V8_EXPORT int v8dbg_parent_Boolean__Oddball = 0;
...
V8_EXPORT int v8dbg_parent_DeoptimizationFrameTranslation__ByteArray = 0;
...
V8_EXPORT int v8dbg_parent_ExternalPointerArray__FixedArrayBase = 0;
V8_EXPORT int v8dbg_parent_ExternalString__String = 0;
V8_EXPORT int v8dbg_parent_ExternalTwoByteString__ExternalString = 0;
V8_EXPORT int v8dbg_parent_False__Boolean = 0;
V8_EXPORT int v8dbg_parent_FeedbackCell__Struct = 0;
V8_EXPORT int v8dbg_parent_FixedAddressArray__FixedIntegerArray = 0;
...
V8_EXPORT int v8dbg_parent_FixedIntegerArray__ByteArray = 0;
V8_EXPORT int v8dbg_parent_GcSafeCode__HeapObject = 0;
V8_EXPORT int v8dbg_parent_HeapNumber__PrimitiveHeapObject = 0;
V8_EXPORT int v8dbg_parent_HeapObject__Object = 0;
V8_EXPORT int v8dbg_parent_InstructionStream__HeapObject = 0;
...
V8_EXPORT int v8dbg_parent_JSDataView__JSDataViewOrRabGsabDataView = 0;
V8_EXPORT int v8dbg_parent_JSDataViewOrRabGsabDataView__JSArrayBufferView = 0;
...
V8_EXPORT int v8dbg_parent_JSPromiseWithResolversResult__JSObject = 0;
V8_EXPORT int v8dbg_parent_JSRabGsabDataView__JSDataViewOrRabGsabDataView = 0;
V8_EXPORT int v8dbg_parent_JSRawJson__JSObject = 0;
...
V8_EXPORT int v8dbg_parent_JSValidIteratorWrapper__JSObject = 0;
...
V8_EXPORT int v8dbg_parent_Null__Oddball = 0;
...
V8_EXPORT int v8dbg_parent_TemplateLiteralObject__JSArray = 0;
V8_EXPORT int v8dbg_parent_ThinString__String = 0;
V8_EXPORT int v8dbg_parent_True__Boolean = 0;
...
V8_EXPORT int v8dbg_parent_Undefined__Oddball = 0;
V8_EXPORT int v8dbg_parent_WeakArrayList__HeapObject = 0;
V8_EXPORT int v8dbg_parent_WeakFixedArray__HeapObject = 0;
/* field information */
V8_EXPORT int v8dbg_class_AllocationSite__transition_info_or_boilerplate__Tagged_Object_ = AllocationSite::kTransitionInfoOrBoilerplateOffset;
V8_EXPORT int v8dbg_class_AllocationSite__nested_site__Tagged_Object_ = AllocationSite::kNestedSiteOffset;
V8_EXPORT int v8dbg_class_AllocationSite__dependent_code__Tagged_DependentCode_ = AllocationSite::kDependentCodeOffset;
V8_EXPORT int v8dbg_class_AllocationSite__weak_next__Tagged_Object_ = AllocationSite::kWeakNextOffset;
V8_EXPORT int v8dbg_class_AllocationMemento__allocation_site__Tagged_Object_ = AllocationMemento::kAllocationSiteOffset;
V8_EXPORT int v8dbg_class_Code__deoptimization_data__Tagged_FixedArray_ = Code::kDeoptimizationDataOrInterpreterDataOffset;
V8_EXPORT int v8dbg_class_Code__bytecode_or_interpreter_data__Tagged_HeapObject_ = Code::kDeoptimizationDataOrInterpreterDataOffset;
V8_EXPORT int v8dbg_class_Code__source_position_table__Tagged_ByteArray_ = Code::kPositionTableOffset;
V8_EXPORT int v8dbg_class_Code__bytecode_offset_table__Tagged_ByteArray_ = Code::kPositionTableOffset;
...
V8_EXPORT int v8dbg_class_FeedbackCell__value__Tagged_HeapObject_ = FeedbackCell::kValueOffset;
V8_EXPORT int v8dbg_class_JSTypedArray__base_pointer__Tagged_Object_ = JSTypedArray::kBasePointerOffset;
V8_EXPORT int v8dbg_class_JSArrayBuffer__detach_key__Tagged_Object_ = JSArrayBuffer::kDetachKeyOffset;
V8_EXPORT int v8dbg_class_JSArrayIterator__raw_kind__SMI = JSArrayIterator::kKindOffset;
V8_EXPORT int v8dbg_class_JSFunction__raw_feedback_cell__Tagged_FeedbackCell_ = JSFunction::kFeedbackCellOffset;
V8_EXPORT int v8dbg_class_JSFunction__context__Tagged_Context_ = JSFunction::kContextOffset;
V8_EXPORT int v8dbg_class_JSFunction__prototype_or_initial_map__Tagged_HeapObject_ = JSFunction::kPrototypeOrInitialMapOffset;
V8_EXPORT int v8dbg_class_JSReceiver__raw_properties_or_hash__Tagged_Object_ = JSReceiver::kPropertiesOrHashOffset;
V8_EXPORT int v8dbg_class_JSMessageObject__shared_info__Tagged_Object_ = JSMessageObject::kSharedInfoOffset;
V8_EXPORT int v8dbg_class_JSMessageObject__bytecode_offset__Tagged_Smi_ = JSMessageObject::kBytecodeOffsetOffset;
...
V8_EXPORT int v8dbg_class_JSGlobalObject__global_dictionary__Tagged_GlobalDictionary_ = JSGlobalObject::kPropertiesOrHashOffset;
V8_EXPORT int v8dbg_class_JSIteratorResult__value__Tagged_Object_ = JSIteratorResult::kValueOffset;
V8_EXPORT int v8dbg_class_JSIteratorResult__done__Tagged_Object_ = JSIteratorResult::kDoneOffset;
V8_EXPORT int v8dbg_class_JSRegExp__last_index__Tagged_Object_ = JSRegExp::kLastIndexOffset;
V8_EXPORT int v8dbg_class_Map__instance_descriptors__Tagged_DescriptorArray_ = Map::kInstanceDescriptorsOffset;
V8_EXPORT int v8dbg_class_Map__raw_transitions__weak = Map::kTransitionsOrPrototypeInfoOffset;
V8_EXPORT int v8dbg_class_Map__prototype__Tagged_HeapObject_ = Map::kPrototypeOffset;
V8_EXPORT int v8dbg_class_Map__prototype_info__Tagged_Object_ = Map::kTransitionsOrPrototypeInfoOffset;
V8_EXPORT int v8dbg_class_Map__dependent_code__Tagged_DependentCode_ = Map::kDependentCodeOffset;
V8_EXPORT int v8dbg_class_Map__constructor_or_back_pointer__Tagged_Object_ = Map::kConstructorOrBackPointerOrNativeContextOffset;
V8_EXPORT int v8dbg_class_Map__native_context__Tagged_NativeContext_ = Map::kConstructorOrBackPointerOrNativeContextOffset;
V8_EXPORT int v8dbg_class_Map__native_context_or_null__Tagged_Object_ = Map::kConstructorOrBackPointerOrNativeContextOffset;
V8_EXPORT int v8dbg_class_Map__wasm_type_info__Tagged_WasmTypeInfo_ = Map::kConstructorOrBackPointerOrNativeContextOffset;
V8_EXPORT int v8dbg_class_Oddball__to_string__Tagged_String_ = Oddball::kToStringOffset;
V8_EXPORT int v8dbg_class_Oddball__to_number__Tagged_Object_ = Oddball::kToNumberOffset;
V8_EXPORT int v8dbg_class_Oddball__type_of__Tagged_String_ = Oddball::kTypeOfOffset;
V8_EXPORT int v8dbg_class_Script__wasm_breakpoint_infos__Tagged_FixedArray_ = Script::kEvalFromSharedOrWrappedArgumentsOffset;
V8_EXPORT int v8dbg_class_Script__wasm_managed_native_module__Tagged_Object_ = Script::kEvalFromPositionOffset;
V8_EXPORT int v8dbg_class_Script__wasm_weak_instance_list__Tagged_WeakArrayList_ = Script::kSharedFunctionInfosOffset;
V8_EXPORT int v8dbg_class_Script__eval_from_shared_or_wrapped_arguments__Tagged_Object_ = Script::kEvalFromSharedOrWrappedArgumentsOffset;
V8_EXPORT int v8dbg_class_Script__eval_from_position__SMI = Script::kEvalFromPositionOffset;
V8_EXPORT int v8dbg_class_Script__compiled_lazy_function_positions__Tagged_Object_ = Script::kCompiledLazyFunctionPositionsOffset;
V8_EXPORT int v8dbg_class_SharedFunctionInfo__function_data__Tagged_Object_ = SharedFunctionInfo::kFunctionDataOffset;
V8_EXPORT int v8dbg_class_SharedFunctionInfo__name_or_scope_info__Tagged_Object_ = SharedFunctionInfo::kNameOrScopeInfoOffset;
V8_EXPORT int v8dbg_class_SharedFunctionInfo__script__Tagged_HeapObject_ = SharedFunctionInfo::kScriptOffset;
V8_EXPORT int v8dbg_class_SharedFunctionInfo__raw_script__Tagged_Object_ = SharedFunctionInfo::kScriptOffset;
V8_EXPORT int v8dbg_class_SharedFunctionInfo__feedback_metadata__Tagged_FeedbackMetadata_ = SharedFunctionInfo::kOuterScopeInfoOrFeedbackMetadataOffset;
V8_EXPORT int v8dbg_class_AccessorPair__getter__Tagged_Object_ = AccessorPair::kGetterOffset;
V8_EXPORT int v8dbg_class_AccessorPair__setter__Tagged_Object_ = AccessorPair::kSetterOffset;
...
V8_EXPORT int v8dbg_class_JSArrayBuffer__byte_length__size_t = JSArrayBuffer::kRawByteLengthOffset;
V8_EXPORT int v8dbg_class_JSArrayBufferView__byte_length__size_t = JSArrayBufferView::kRawByteLengthOffset;
V8_EXPORT int v8dbg_class_JSArrayBufferView__byte_offset__size_t = JSArrayBufferView::kRawByteOffsetOffset;
...
V8_EXPORT int v8dbg_class_JSTypedArray__length__Object = JSTypedArray::kRawLengthOffset;
...
V8_EXPORT int v8dbg_class_InstructionStream__instruction_start__uintptr_t = InstructionStream::kHeaderSize;
